...
minetest.register_on_joinplayer(function(player)
	...
	if player:get_meta():get("lott:immunity") ~= nil then
		...
		minetest.chat_send_player(name, minetest.colorize("green", string.format(S("You still have %s minutes left!"), (tonumber(player:get_meta():get_string("lott:immunity")) / 60))))
